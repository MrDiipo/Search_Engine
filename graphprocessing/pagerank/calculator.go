...
// Calculator executes the iterative version of the PageRank
// Algorithm on a graph until the desired level of convergence
// is reached.
...
// Graph returns the underlying bspgraph instance
func (c *Calculator) Graph() *bspgraph.Graph {
	return c.g
}

// Executor creates and returns a bspgraph.Executor for running the
// PageRank algorithm once the graph layout has been properly set up.
