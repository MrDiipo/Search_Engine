...
var defaultPrivateCIDRs = []string{
	...
	"fe80::/10",
	// Miscellaneous
	"0.0.0.0/8",          // IP addresses on local machine
...
// NewDetector returns a new Detector instance which is initialized with
// the default list of IPv4/IPv6 CIDR blocks that correspond to private networks
